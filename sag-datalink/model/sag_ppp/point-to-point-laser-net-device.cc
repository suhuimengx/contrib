...
void
PointToPointLaserNetDevice::SAGLinkDoSomethingWhenSend (Ptr<Packet> p)
{
  //for vartual
}

void
PointToPointLaserNetDevice::SAGLinkDoSomethingWhenReceive (Ptr<Packet> p)
{
  //for vartual
}
...
void 
PointToPointLaserNetDevice::SetLinkState (P2PLinkState p2pLinkState)
{
  NS_LOG_FUNCTION (this);
...
void 
PointToPointLaserNetDevice::NotifyStateToL3Stack (P2PLinkState p2pLinkState)
{
...
bool
PointToPointLaserNetDevice::Attach (Ptr<SAGPhysicalLayer> ch)
{
  NS_LOG_FUNCTION (this << &ch);

  m_channel = ch->GetObject<PointToPointLaserChannel>();
...
double
PointToPointLaserNetDevice::GetQueueOccupancyRate(){
	NS_LOG_FUNCTION (this);
  ...
  uint16_t protocolNumber)
{
  ...
  if (enq)
    {
//	  if(m_queue->GetNPackets() > 98)
//	  if(m_node->GetId() == 100)
//	  std::cout<<Simulator::Now()<<"  "<<m_node->GetId()<<"  "<<m_destination_node->GetId()<<"  "<<m_queue->GetNPackets()<<"  "<<m_queue->GetCurrentSize()
//	  <<"  "<<m_queue->GetMaxSize()<<"  "<<m_queue->GetNBytes()<<"  "<<m_queue->GetMaxSize()<<std::endl;
      //
...
uint32_t
PointToPointLaserNetDevice::GetMaxsize(){
...
void
PointToPointLaserNetDevice::SetInterruptionInformation(P2PInterruptionType metaData, bool b){
	NS_LOG_FUNCTION (this);
	m_metaData[metaData] = b;
}

bool
PointToPointLaserNetDevice::GetInterruptionInformation(P2PInterruptionType metaData){
	NS_LOG_FUNCTION (this);
