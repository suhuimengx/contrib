...
#ifndef SAG_CSMA_BACKOFF_H
#define SAG_CSMA_BACKOFF_H
...
public:
   ...
   */
  SAGCsmaBackoff (Time slotTime, uint32_t minSlots, uint32_t maxSlots, uint32_t ceiling, uint32_t maxRetries);
