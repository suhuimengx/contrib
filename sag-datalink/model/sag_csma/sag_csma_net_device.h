...
#ifndef SAG_CSMA_NET_DEVICE_H
#define SAG_CSMA_NET_DEVICE_H
...
class SAGCsmaNetDevice: public SAGLinkLayerGSL
{
public:
  /**
...
private:
   ...
   */
  SAGCsmaNetDevice& operator = (const SAGCsmaNetDevice &o);
   ...
   * \param o Other NetDevice
   */
  SAGCsmaNetDevice (const SAGCsmaNetDevice &o);

  SAGCsmaBackoff m_backoff;
