...
SatLinkResults::GetTypeId()
{
    static TypeId tid = TypeId("ns3::SatLinkResults")
			...
			.AddAttribute ("BaseDir",
				            ...
				            StringValue (""),
				            MakeStringAccessor (&SatLinkResults::m_baseDir),
				            MakeStringChecker ());
    return tid;
}
    ...
    : m_isInitialized(false)
{
	...
	//std::cout<<"1"<<m_baseDir<<std::endl;
    //m_inputPath = m_baseDir+ "/linkresults/";
    //m_inputPath = "/home/xiaoyuliu/platform_v3/data/test_data/linkresults/";
}
...
void
SatLinkResults::SetBaseDir(std::string baseDir){
	m_baseDir = baseDir;
    m_inputPath = m_baseDir+ "/linkresults/";
}
