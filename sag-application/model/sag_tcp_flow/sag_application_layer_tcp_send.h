...
#ifndef SAG_APPLICATION_LAYER_TCP_SEND_H
#define SAG_APPLICATION_LAYER_TCP_SEND_H
...
class SAGApplicationLayerTcpSend : public SAGApplicationLayer
{
public:
  static TypeId GetTypeId (void);
  SAGApplicationLayerTcpSend ();
  virtual ~SAGApplicationLayerTcpSend ();
