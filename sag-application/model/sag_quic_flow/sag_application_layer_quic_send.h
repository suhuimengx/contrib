...
#ifndef SAG_APPLICATION_LAYER_QUIC_SEND_H
#define SAG_APPLICATION_LAYER_QUIC_SEND_H
...
class SAGApplicationLayerQuicSend : public SAGApplicationLayer
{
public:
  static TypeId GetTypeId (void);
  SAGApplicationLayerQuicSend ();
  virtual ~SAGApplicationLayerQuicSend ();
  ...
  void SetFlowEntry(SAGBurstInfoTcp entry);
