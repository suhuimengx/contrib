...
#ifndef SAG_ROUTING_HELPER_H
#define SAG_ROUTING_HELPER_H
...
class SAGRoutingHelper : public Ipv4RoutingHelper
{
public:
    static TypeId GetTypeId(void);
    SAGRoutingHelper ();
	~SAGRoutingHelper ();
    SAGRoutingHelper (const SAGRoutingHelper &);
    SAGRoutingHelper* Copy (void) const;
    ...
    //SAGRoutingHelper &operator = (const SAGRoutingHelper &);

    void StoreIPAddresstoNodeId();
    virtual void UpdateIpAddresstoNodeId();
