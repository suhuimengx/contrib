...
#include "ns3/iadr-build-routing.h"
...
class Iadr_Rout: public SAGRoutingProtocal {
public:
	static TypeId GetTypeId(void);
	static const uint8_t IADR_PROTOCOL;
...
private:
    ...
    /// Routing algorithm
    Ptr<IadrBuildRouting> m_routeBuild;
...
private:
	...
	*/
    void RecvIADR (Ptr<Packet> p, Ipv4Address receiver, Ipv4Address src);
