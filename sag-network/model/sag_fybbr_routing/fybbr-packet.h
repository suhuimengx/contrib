 ...
 *      Author: root
 */
#ifndef FYBBRPACKET_H
#define FYBBRPACKET_H
...
enum MessageType
{
	FYBBRTYPE_HELLO  = 1,   //!< FYBBRTYPE_HELLO
	FYBBRTYPE_DBD  = 2,   //!< FYBBRTYPE_DBD
  //OSPFTYPE_COLLECT  = 3,   //!< FYBBRTYPE_COLLECT    controller-->nodes to collect
	FYBBRTYPE_RTS = 3 //!< FYBBRTYPE_ROUT             nodes-->controller to distribute routing table
  //OSPFTYPE_LSAck = 5 //!<OSPFTYPE_LSAck
};

/**
* \ingroup fybbr
* \brief FYBBR Packet types
*/
...
public:
  /**
   * constructor
   * \param t the FYBBR HELLO type
   */
  TypeHeader (MessageType t = FYBBRTYPE_HELLO);
...
/**
* \ingroup fybbr
* \brief   FYBBR Packet Header Format
  \verbatim
          0                   1                   2                   3
...
class FybbrHeader : public Header
{
public:
  /**
   * constructor
   ...
   * \param
   */
  FybbrHeader(uint8_t packetLength = 0, Ipv4Address routerID = Ipv4Address (), Ipv4Address areaID = Ipv4Address (),
  ...
  bool operator== (FybbrHeader const & o) const;
