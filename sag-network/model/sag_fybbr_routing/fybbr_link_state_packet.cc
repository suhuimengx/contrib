...
LSAHeader::GetTypeId ()
{
    static TypeId tid = TypeId ("ns3::fybbr::LSAHeader")
            .SetParent<Header> ()
            .SetGroupName ("FYBBR")
...
LSAPacket::GetTypeId ()
{
    static TypeId tid = TypeId ("ns3::fybbr::LSAPacket")
            .SetParent<Header> ()
            .SetGroupName ("FYBBR")
...
LSALinkData::GetTypeId () {
    static TypeId tid = TypeId("ns3::fybbr::LSALinkData")
            .SetParent<Header>()
            .SetGroupName("FYBBR")
...
LSUHeader::GetTypeId ()
{
    static TypeId tid = TypeId ("ns3::fybbr::LSUHeader")
            .SetParent<Header> ()
            .SetGroupName ("FYBBR")
