...
{
  static TypeId tid = TypeId ("ns3::fybbr::TypeHeader")
    .SetParent<Header> ()
    .SetGroupName ("FYBBR")
...
FybbrHeader::FybbrHeader (uint8_t packetLength, Ipv4Address routerID, Ipv4Address areaID,
...
NS_OBJECT_ENSURE_REGISTERED (FybbrHeader);

TypeId
FybbrHeader::GetTypeId ()
{
  static TypeId tid = TypeId ("ns3::fybbr::FybbrHeader")
    .SetParent<Header> ()
    .SetGroupName ("FYBBR")
    .AddConstructor<FybbrHeader> ()
  ;
  return tid;
}

TypeId
FybbrHeader::GetInstanceTypeId () const
{
  return GetTypeId ();
}

uint32_t
FybbrHeader::GetSerializedSize () const
{
  return 10;
}

void
FybbrHeader::Serialize (Buffer::Iterator i) const
{
...
uint32_t
FybbrHeader::Deserialize (Buffer::Iterator start)
{
  Buffer::Iterator i = start;
...
void
FybbrHeader::Print (std::ostream &os) const
{

}

bool
FybbrHeader::operator== (FybbrHeader const & o ) const
{
...
{
  static TypeId tid = TypeId ("ns3::fybbr:HelloHeader")
    .SetParent<Header> ()
    .SetGroupName ("FYBBR")
...
DDHeader::GetTypeId ()
{
  static TypeId tid = TypeId ("ns3::fybbr::DDHeader")
    .SetParent<Header> ()
    .SetGroupName ("FYBBR")
