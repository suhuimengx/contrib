...
#ifndef SAG_PLATFORM_MASTER_FYBBR_LINK_STATE_PACKET_H
#define SAG_PLATFORM_MASTER_FYBBR_LINK_STATE_PACKET_H
...
#endif //SAG_PLATFORM_MASTER_FYBBR_LINK_STATE_PACKET_H
