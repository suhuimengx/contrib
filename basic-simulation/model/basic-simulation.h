...
public:
    ...
    void SetDistributedNodeSystemIdAssignment(std::vector<int64_t> assignment);
    std::vector<int64_t> GetDistributedNodeSystemIdAssignment();
    std::string GetNodeAssignmentAlogirthm();
...
//    void CleanUpSimulation();
    ...
    std::string  m_distributed_assign_algorithm;
    ...
    std::vector<float> m_current_sim_speed_simulation_sec_per_wallclock_sec;
    std::vector<float> m_current_sim_speed_simulation_time;
